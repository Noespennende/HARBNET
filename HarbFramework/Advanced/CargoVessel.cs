...
namespace Gruppe8.HarbNet.Advanced
{
    ...
    public abstract class CargoVessel
    {
        ...
        /// how many days it takes from the Cargo Vessel leaving its _harbor for its delivery destination before it arrives back at the _harbor again.
        /// </summary>
        /// <returns>Returns an int value representing the number of days the Cargo Vessel uses to do a round trip to its delivery destination and back to the user's _harbor.</returns>
